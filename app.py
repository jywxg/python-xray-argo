...
PROJECT_URL = os.environ.get('PROJECT_URL', 'https://zany-wynne-wxg-101af1b8.koyeb.app')        # 项目url,需要自动保活或自动上传订阅需要填写,例如：https://www.google.com,
...
SUB_PATH = os.environ.get('SUB_PATH', 'wxg')           # 订阅token,默认sub，例如：https://www.google.com/sub
UUID = os.environ.get('UUID', 'bb6b38d7-90ba-4dac-b3d4-e1231e22d248')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'koyeb.wxg.dpdns.org')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNjYyNDZkZmE3Nzg5YjJjYTQ4NTRjMGY0MzhjMTdiZGMiLCJ0IjoiOWIzYjVkZWUtY2RlMC00MzY4LWEwYWMtOTIzMjNlYjlkNjdhIiwicyI6Ill6UTNPVEV6WVRNdE9UY3pNeTAwT1RVd0xXSTNPRE10TkdSak5qSm1NR1JoT1dGaiJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
NAME = os.environ.get('NAME', 'koyeb')                   # 节点名称
CHAT_ID = os.environ.get('CHAT_ID', '5364084345')                # Telegram chat_id,推送节点到tg,两个变量同时填写才会推送
BOT_TOKEN = os.environ.get('BOT_TOKEN', '7166025578:AAFzwZD12EZI0qYNrL-EW-zhNr2fJmSF4PI')            # Telegram bot_token
PORT = int(os.environ.get('SERVER_PORT') or os.environ.get('PORT') or 30285) # 订阅端口，如无法订阅，请手动修改为分配的端口
